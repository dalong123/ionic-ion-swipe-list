(function(ionic) {
    ...
    SlideDrag.prototype.end = function(e, doneCallback) {
        var self = this,
            offsetX, leftWidth, rightWidth, restingPoint, tooSlow;
    ...
    /**
     * The SwipeListView handles a list of items. It will process drag animations, edit mode,
     * and other operations that are common on mobile lists or table views.
     */
    ionic.views.SwipeListView = ionic.views.View.inherit({
    ...
    angular.module('ionic.contrib.ui.swipe.list', ['ionic'])

    .directive('ionSwipeItem', ['$$rAF',
        function($$rAF) {
            return {
                restrict: 'E',
    ...
    .directive('ionSwipeItemOptionButton', [
        function() {
                    ...
                    return function($scope, $element, $attr, itemCtrl) {
                        if (side == 'left') {
                            if (!itemCtrl.optionsContainerLeft) {
                                itemCtrl.optionsContainerLeft = angular.element(ITEM_TPL_OPTION_BUTTONS);
                            ...
                            if (!itemCtrl.optionsContainerRight) {
                                itemCtrl.optionsContainerRight = angular.element(ITEM_TPL_OPTION_BUTTONS);
